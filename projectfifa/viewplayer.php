...
<body>
    ...
    <div class="container_main">
        <?php
        $query = "SELECT * FROM `brazilgk` WHERE id=$_GET[id]";
...
<div class="form-group">
            ...
            <input type="text" name="gs" value=" $fetch[gs]" class="form-control" required>
</div>
<br>
<div class="form-group">
...
<input type="submit" name="updateplayer" Value="Update" class="btn1">
</form>
</div>
</div>
print;
