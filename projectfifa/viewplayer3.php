...
<body>
    ...
    <div class="container_main">
        ...
        <?php
        $query = "SELECT * FROM `brazilfd` WHERE id=$_GET[id]";
        ...
        echo <<<print
<div class="container">
<img class="border" style="float:left; margin-right:25px; margin-top:30px; width:14%; height:5%" src="$fetchsrc$fetch[image]">
        <div class="col-8">
...
<input type="submit" name="updateplayer3" Value="Update" class="btn1">
</form>
</div>
</div>
print;
